rem java -Denv=dev -Dspring.profiles.active=pro -classpath ..\conf -jar ..\lib\data-client.jar
...
java -Xms64m -Xmx1024m -XX:MaxPermSize=64M -classpath ..\conf;%LIB_JARS% com.ckjava.Run
goto end
